...
@section('contents')
    ...
    <div class="card uper">
        <div class="card-header">
          ...
          <div class="card-header">
            <a class="btn btn-primary" href="{{ url('hotel') }}"> Back</a>
        </div>
    </div>
      <div class="card-body">
        @if ($errors->any())
        ...
        @endif
         ...
         <form method="POST" action="{{ url('hotel/store') }}">
            <div class="form-group">
                  @csrf
                    <!-- <label for="name">Pid Number:</label>
                    <input type="text" name="pid" class="form-control" value="{{ rand(111111,999999) }}" placeholder="Pid Number" readonly> -->
            </div>
                <div class="form-group">
