                            ...
                            <div class="table-responsive">
                                ...
                                <div class="row">
                                    <div class="col-md-12 paginate" id="print-button-dym">
                                        <a href="{{url('jabi/preview')}}?office_ids={{ json_encode($offices_box) }}" onclick="previewPrintAll()" class="btn btn-primary col-md-12">
        ...
        function replacePrintButton(){
            if(all_customer_ids.length > 0 && $(`#select-all`).is(':checked') == false){
                $("#print-button-dym").html(`
                    <a href="{{url('jabi/preview')}}?office_ids=[${all_customer_ids}]" onclick="previewPrintAll()" class="btn btn-primary col-md-12">
                        <i class="fa fa-print"></i> Print All
                    </a>
                `);
            }else{
