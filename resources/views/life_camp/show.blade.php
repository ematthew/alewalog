                        ...
                        <div class="card-body">
                            <div class="print-wrapper">
                                   ...
                                   <div class="col-md-2">
                                      ...
                                      <div class="col-md-8">
                                       ...
                                       <h3 style="font-family: tahoma; color:black;font-size:16px; text-align: center; font-weight:bold;">Secretariat: No 1 Olusegun Obasanjo Way, Area 10 Garki - Abuja</h3>
                                        <h4 style="font-family: tahoma; color:black;font-size:16px; text-align:center; 60px; font-weight:bold;">Annex Office: Suit C3,  2nd floor ZARA Plaza, opposite wallpapper Life camp. Life camp District, FCT Abuja. </h4>
                                        <h5 style="font-family: tahoma; color:black;font-size:16px; text-align: center; font-weight:bold;">Life camp District, FCT Abuja. </h5>
                                        <h6 style="font-family: tahoma; color:red;font-size:20px; text-align: center; font-weight:bold;">Tel:+234967287994,+234808065448701  </h6>
                                   </div>
                                    <div class="col-md-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <p style="text-align: center; font-family: tahoma; font-size:18px;; color: black;"><b>BILL INFORMATION</b></p>
                                        <div class="row-border" style="color:#000 !important;border: 1px solid #000 !important;">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row-border px-4 py-2" style="color:#000 !important; border: 1px solid #000 !important;font-family:sans-serif;font-size:18px; text-align:justify;">
                                          ...
                                          <b>
                                                    In accordance with the provision of section 7 (4th Schedule ) of the 1999 constitution of the Federal Republic Of Nigeria ; Federal Capital Territory Act Cap 503, LFN 2004 (vol.3) as amended: Taxes and Levies ( Approved list of Collection ) Act 2015 (as amended) and AMAC Tenement Rate bye-laws of 2014. We forwarded herewith your bill for the year {{ date("Y ") }}, totaling  <span ><strong class="text-danger"><b><span>&#8358;</span>{{ number_format($office->grand_total, 2) }}</b></strong></b></span> <b>in respect of the landed property (ies) you are occupying in Abuja Municipal Area Council as per details above.</b>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row-border px-4 py-2" style="color:#000 !important;border: 1px solid #000 !important; justify-content: 10px;">
                                        <div class="row">
                                                    <div class="col-md-10">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row-border px-4 py-2" style="color:#000 !important;border: 1px solid #000 !important;">
                                            <strong class="text-danger" style="font-family: tahoma; font-size:18px;" ><b>NOTE</b></strong> <b style="font-family: tahoma; font-size:18px;style="font>:Ensure you collect Electronic and Treasury receipt(s) at the Annex Office Suite 306, 3rd Floor Kano House. Ralph Shodeinde Street, Central Business District, Abuja.</b>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6" style="margin-top:60;">
                                        <div class="row-border px-4 py-2" style="border: 1px solid #000 !important;">
                                            <div class="text-center" style="color:#000 !important;"><p><strong style="font-family: tahoma; font-size:18px;">ACKNOWLEDGEMENT</strong></p></div>
                                        ...
                                        <div class="row-border px-4 py-2" style="border: 1px solid #000 !important;">
                                            <div class="text-center" style="color:#000 !important;"><p><strong style="font-family: tahoma; font-size:18px;">FOR OFFICIAL USE ONLY</strong></p></div>
                                            <table style="color:#000 !important;">
                                                  <tr>
