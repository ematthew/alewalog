...
<div id="content">
 ...
 -->
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered small" width="100%" id="office_table" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $demand->active }}</td>
                                        <td>
                                            <a href="{{url('nasarawa/view')}}?pid={{ $demand->pid }}" class="">
                            ...
                            <div class="row">
                                <div class="col-md-12 paginate">
                                    <a href="{{url('nasarawa/preview')}}?office_ids={{ json_encode($demands_box) }}" onclick="previewPrintAll()" class="btn btn-primary col-md-12">
