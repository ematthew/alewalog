                            ...
                            @foreach($offices as $key => $office)
                                    ...
                                    <div class="col-md-8">
                                       ...
                                       <h4 style="font-family: tahoma; color:black;font-size:16px; text-align:center; 60px; font-weight:bold;">Annex Office: 34, First Plaza Karu-Jikwoye Road, Nyanya Abuja FCT Abuja, </h4>
                                        <h5 style="font-family: tahoma; color:black;font-size:16px; text-align: center; font-weight:bold;">Nyanya Abuja FCT Abuja, Abuja.FCT </h5>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div style="margin-left:100px;margin-right:100px;margin-top: 10px; color:#000 !important;">
                                                <table class="table table-bordered" style="color:#000 !important;">
                                                    <tr>
                                                        <th class="thr"style="font-family: tahoma; font-size:17px;"><strong style="font-family: tahoma; font-size: 17px; color:red;">Tenement Rate Reminder Notice is hereby given to </strong></th>
                                            ...
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <div class="pl-2">
                                                        ...
                                                        <table>
                                                            <tr>
                                                                <td style="color: black; font-family: tahoma; font-size:15px;"><b>Name of Occupier :</b></td>
                                                                <td style="color: blue; font-family: tahoma; font-size:15px;"><b>{{ $office->occupant }}</b></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="color:black; font-family: tahoma; font-size:15px;"><b>Assesment No :</b></td>
                                                                <td style="color:blue; font-family: tahoma; font-size:15px;"><b>{{ $office->asset_no }}</b></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="color:black; font-family: tahoma; font-size:15px;"><b>Property Address :</b></td>
                                                                <td style="color:blue; font-family: tahoma; font-size:15px;"><b>{{ $office->prop_addr }}</b></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="color:black; font-family: tahoma; font-size:15px;"><b>Cadastral Zone :</b></td>
                                                                <td style="color:blue; font-family: tahoma; font-size:15px;"><b>{{ $office->cadastral_zone }}</b></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="color:black; font-family: tahoma; font-size:15px;"><b>Use of Property :</b></td>
                                                                <td style="color:blue; font-family: tahoma; font-size:15px;"><b>{{ $office->prop_use }}</b></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="color:black; font-family: tahoma; font-size:15px;"><b>Rating District :</b></td>
                                                                <td style="color:blue; font-family: tahoma; font-size:15px;"  ><b>{{ $office->rating_dist }}</b></td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 pr-4">
                                                    <div class="text-center">
                                                        ...
                                                        <br>
                                                        <p class="text-danger" style="font-family: tahoma; font-size:15px;"><b>PID-{{ $office->pid }}<br> {{ date("Y-m-d H:i ") }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row-border px-4 py-2" style="color:#000 !important; border: 1px solid #000 !important;font-family:tahoma;font-size:18px;">
                                            <div class="row">
                                                <div class="col-md-10">
                                                       ...
                                                       <b>2. Internet Banking Transfer:<span class="text-danger" style="font-family:tahoma; font-size:18px;"> <strong><b>Abuja Municipal Area Council, FCMB Account. No. 8672253011</b></strong></span> </b> <br />
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row-border px-4 py-2" style="color:#000 !important;border: 1px solid #000 !important;">
                                            <strong class="text-danger" style="font-family: tahoma; font-size:19px;" ><b>NOTE</b></strong> <b style="font-family:tahoma;font-size:19px;" >:Ensure you collect Electronic and Treasury receipt(s) at the Annex Office Suite 306, 3rd Floor Kano House. Ralph Shodeinde Street, Central Business District, Abuja.</b>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                   <div class="col-6" style="color:#000 !important;">
                                        <div class="">
                                          <strong style="font-family: tahoma;font-size:20px;"> Your early compliance will be highly appreciated</strong>
                                        </div>
                                        <div class="">
                                            <div class="row" style="">
                                        ...
                                        <div class="col-md-6" style="margin-top:10;">
                                            ...
                                            <div class="row-border px-4 py-2" style="border: 1px solid #000 !important;">
                                            <div class="text-center" style="color:#000 !important;"><p><strong style="font-family: tahoma;">FOR OFFICIAL USE ONLY</strong></p></div>
                                            <table style="color:#000 !important;">
                                                  <tr>
