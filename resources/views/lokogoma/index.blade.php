                ...
                <div class="col-xl-12 col-md-12 mb-4">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <a class="btn btn-success" href="{{ url('lokogoma/create') }}" title="add of office"> <i class="fas fa-plus-circle"></i> </a>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($offices as $key => $office)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{url('lokogoma/view')}}?pid={{ $office->pid }}" class="">
                                                        <i class="fa fa-print"></i> Print
                                                    </a>
                                                    <a href="{{ url('lokogoma/edit/'.$office->id) }}" class=""><i class="fa fa-edit"></i> Edit </a>
                                                </td>
                                ...
                                <div class="row">
                                    <div class="col-md-12 paginate" id="print-button-dym">
                                        <a href="{{url('lokogoma/preview')}}?office_ids={{ json_encode($offices_box) }}" onclick="previewPrintAll()" class="btn btn-primary col-md-12">
