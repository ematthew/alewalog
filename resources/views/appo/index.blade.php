                            ...
                            <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($demands as $key => $demand)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{url('appo/demands/view')}}?pid={{ $demand->pid }}" class="">
                                ...
                                <div class="row">
                                    <div class="col-md-12 paginate" id="print-button-dym">
                                        <a href="{{url('appo/demands/preview')}}?office_ids={{ json_encode($demands_box) }}" onclick="previewPrintAll()" class="btn btn-primary col-md-12">
