                            ...
                            <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($offices as $key => $office)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{url('appo/reminder/view')}}?pid={{ $office->pid }}" class="">
                                ...
                                <div class="row">
                                    <div class="col-md-12 paginate" id="print-button-dym">
                                        <a href="{{url('appo/reminder/preview')}}?office_ids={{ json_encode($offices_box) }}" onclick="previewPrintAll()" class="btn btn-primary col-md-12">
