...
class DemandController extends Controller
{
    ...
    */
    ...
    public function store(Request $request)
    {
        ...
        $demand->save();
        return redirect('demands')->with('success', 'demand information has been created Successfully');
    }
    ...
    public function update($id, Request $request)
    {
        ...
        if (Auth::user()->user_type == 'super') {
            ...
            return redirect('demands')->with('success', 'office information has been created Successfully');
        } else {
            return redirect()->back();
        }
    }
